...
public class HanfireJobModel
{
    ...
    public HanfireJobModel(string jobName, string url, string method, int delayFromMinutes)
    {
    ...
    public HanfireJobModel(string jobName, string url, string method, DateTime runAt)
    {
        this.JobName = jobName;
        this.Url = url;
        this.Method = method;
    ...
    public HanfireJobModel(string jobName, string url, string method, string corn)
    {
        this.JobName = jobName;
        this.Url = url;
        this.Method = method;

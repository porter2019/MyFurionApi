...
public class SqlSugarRepository<TEntity> where TEntity : class, new()
{
    ...
    /// <returns></returns>
    public virtual int Update(TEntity entity, params string[] ignoreColumns)
    {
        return EntityContext.Updateable(entity).IgnoreColumns(UpdateIgnoreColumns.Concat(ignoreColumns).ToArray()).ExecuteCommand();
    }
    ...
    /// <param name="ignoreColumns"></param>
    /// <returns></returns>
    public virtual async Task<int> UpdateAsync(TEntity entity, params string[] ignoreColumns)
    {
